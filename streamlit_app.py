...
st.markdown(f"""
    ...
    /* 🏷️ SN 标签强化 */
    .sn-pill {{ 
        padding: 4px 12px; border-radius: 40px; font-size: 0.7rem; font-weight: 800; 
    ...
    div.stButton > button {{ 
        ...
        font-weight: 800 !important; /* 字体对齐数字 */
    ...
    div.stButton > button:hover {{ 
        ...
        box-shadow: 0 0 30px 5px rgba(56, 189, 248, 0.5) !important;
