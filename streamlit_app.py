...
st.markdown(f"""
    ...
    @keyframes neonPulseBlue {{
        ...
        50% {{ box-shadow: 0 0 25px rgba(56, 189, 248, 0.5); border-color: rgba(56, 189, 248, 0.8); }}
    }}
    @keyframes neonPulseOrange {{
        0%, 100% {{ box-shadow: 0 0 10px rgba(245, 158, 11, 0.2); border-color: rgba(245, 158, 11, 0.4); }}
    ...
    .user-profile:hover {{ transform: translateY(-4px); background: rgba(56, 189, 248, 0.1); border-color: #38bdf8; box-shadow: 0 10px 30px rgba(0,0,0,0.5), 0 0 20px rgba(56, 189, 248, 0.3); }}
    .user-profile:active {{ transform: translateY(-1px) scale(0.97); box-shadow: 0 0 35px rgba(56, 189, 248, 0.6); }}
    .avatar {{ width: 38px; height: 38px; border-radius: 50%; border: 2px solid #38bdf8; background: #0c1e3d; object-fit: cover; animation: neonPulseBlue 3s infinite ease-in-out; }}
    ...
    .wide-card {{
        ...
        animation: fadeIn 0.8s ease-out; cursor: default;
    }}
    
    /* 蓝色卡片(汇总) */
    .normal-card {{ border-left: 4px solid rgba(56, 189, 248, 0.4); animation: fadeIn 0.8s ease-out, neonPulseBlue 4s infinite ease-in-out; }}
    .normal-card:hover {{
        transform: translateY(-6px); background: rgba(56, 189, 248, 0.05);
        border-color: #38bdf8; box-shadow: 0 15px 40px rgba(0,0,0,0.4), 0 0 25px rgba(56, 189, 248, 0.2);
    }}
    .normal-card:active {{ transform: translateY(-2px) scale(0.99); box-shadow: 0 0 30px rgba(56, 189, 248, 0.4); }}

    /* 橙色卡片(异常) */
    .error-card {{ border-left: 4px solid rgba(245, 158, 11, 0.4); animation: fadeIn 0.8s ease-out, neonPulseOrange 4s infinite ease-in-out; }}
    .error-card:hover {{
        transform: translateY(-6px); background: rgba(245, 158, 11, 0.05);
        border-color: #f59e0b; box-shadow: 0 15px 40px rgba(0,0,0,0.4), 0 0 25px rgba(245, 158, 11, 0.2);
    }}
    .error-card:active {{ transform: translateY(-2px) scale(0.99); box-shadow: 0 0 30px rgba(245, 158, 11, 0.4); }}
    ...
    .stTabs [data-baseweb="tab"] {{
        height: 32px !important; padding: 0 18px !important; font-size: 0.85rem !important; border-radius: 40px !important;
