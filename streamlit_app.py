...
st.markdown(f"""
    ...
    @keyframes profile-breath {{
        0% {{ box-shadow: 0 0 5px rgba(255, 255, 255, 0.2); border-color: rgba(255, 255, 255, 0.3); }}
        50% {{ box-shadow: 0 0 25px rgba(56, 189, 248, 0.6); border-color: rgba(56, 189, 248, 0.8); }}
        100% {{ box-shadow: 0 0 5px rgba(255, 255, 255, 0.2); border-color: rgba(255, 255, 255, 0.3); }}
    }}
    ...
    .user-profile {{
        ...
        animation: profile-breath 3s infinite ease-in-out; /* 呼吸效果 */
    }}
    .user-profile:hover {{ 
        transform: scale(1.1); 
    ...
    /* 🏷️ SN 气泡：取消放大，仅保留光效和去下划线 */
    .sn-pill {{ 
        padding: 5px 15px; border-radius: 40px; font-size: 0.75rem; font-weight: 700; 
        transition: all 0.2s ease; border: 1.5px solid transparent; margin: 3px; 
    ...
    .normal-sn:hover {{ 
        ...
        box-shadow: 0 0 15px #38bdf8; text-decoration: none !important; 
        /* transform: scale(1); 显式取消放大 */
    }}
    ...
    .error-sn-pill:hover {{ 
        ...
        box-shadow: 0 0 15px #f59e0b; text-decoration: none !important; 
    }}
